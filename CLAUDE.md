...
| Current substrate version | v0.2.12 bundled (chain through v0.2.12; bundled forward-applied v0.2.4 → v0.2.10 → v0.2.11 → v0.2.12 directly per BL-0021 — skips intermediate v0.2.5-v0.2.9 substrate features) |
