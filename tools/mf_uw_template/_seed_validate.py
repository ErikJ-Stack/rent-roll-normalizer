...
NAME = [
 ...
 (r"admin|community fee|amenity fee|transfer fee|set up", "Admin Fees"),
 (r"keys|access card|vending|stockwell|fines|forfeit|damages|consulting|interest income|vendor rebate|misc|other income|recovery", "Misc Other Income"),
 # expenses
 (r"make.?ready|redecorat|tub (glaz|refinish)|carpet (clean|repair)|unit clean|drywall|paint contractor|resurfac|housekeeper|blinds", "Make-Ready / Turnover"),
 ...
 (r"electric", "Utilities — Electric"), (r"internet|cable", "Utilities — Internet/Cable"),
 ...
 (r"advertis|marketing|leasing|brochure|promotion|\bils\b|seo|website|referral|prospect|reputation", "Leasing & Marketing"),
 (r"payroll|salar|wages|bonus|401k|burden|group insurance|benefit|simple ira|futa|suta|\bsui\b|medicare|soc sec|staffing", "Payroll — On-Site"),
 ...
 (r"dues|office|bank charge|software|accounting|background|computer|data|uniform|printer|copier|license|permit|postage|mileage|telephone|\bcell|training|seminar", "General & Administrative"),
]
