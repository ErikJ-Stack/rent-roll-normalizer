...
> Generated from `tools/mf_uw_template/registry.json` on 2026-06-21 21:26 UTC.  **Do not edit by hand** — edit `registry.json` and re-run `python tools/mf_uw_template/build_mapping_artifacts.py`.

- Product line: **MF** (multifamily). No Analyzer substrate — source is the raw operator docs in `MF Docs/`.
- Primary template: `v20` → `assets/MF_UW_Model_v20.xlsx`
...
| Concept | Source | Target (`v20`) | Status | Notes |
|---|---|---|---|---|
